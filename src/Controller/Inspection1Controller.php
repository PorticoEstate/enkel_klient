...
class Inspection1Controller extends BaseFormController
{
    use UtilityTrait;
    ...
    {
        $session_info = $this->apiClient->get_session_info();
        $url = $this->apiClient->get_backend_url() . "/index.php?";
    ...
    public function handleMultiUploadFile(Request $request, Response $response): Response
    {
        ...
        $url = $this->apiClient->get_backend_url() . "/index.php?" . http_build_query([
